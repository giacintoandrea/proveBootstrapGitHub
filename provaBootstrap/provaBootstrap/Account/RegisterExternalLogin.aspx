<%@ Page Language="C#" Title="Registra account di accesso esterno" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegisterExternalLogin.aspx.cs" Inherits="provaBootstrap.Account.RegisterExternalLogin" %>
